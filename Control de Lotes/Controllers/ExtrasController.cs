...
namespace Control_de_Lotes.Controllers
{
    public class ExtrasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nota,LoteId")] Extras extras)
        {
            ...
            ViewData["LoteId"] = new SelectList(_context.Set<Lote>(), "Id", "Id", extras.LoteId);
            return View(extras);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nota,LoteId")] Extras extras)
        {
            if (id != extras.Id)
            {
                return NotFound();
